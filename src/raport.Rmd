...
```
Funkcja `hclust2` z pakietu Genie jest hierarchicznym algorytmem analizy skupień opartą na minimalnym drzewie rozpinającym. 
...
```
```{r fig.width=6, fig.height=3.4, echo=FALSE, fig.align='center'}
    drawComparisonPlot("custom_5", "M = 20")
```
```{r fig.width=6, fig.height=3.4, echo=FALSE, fig.align='center'}
     drawComparisonPlot("custom_5", "M = 100")
```
```{r fig.width=6, fig.height=3.4, echo=FALSE, fig.align='center'}
    drawComparisonPlot("custom_5", "M = 200")
```
```{r fig.width=6, fig.height=3.4, echo=FALSE, fig.align='center'}
    drawComparisonPlot("custom_5", "M = 500")
```
